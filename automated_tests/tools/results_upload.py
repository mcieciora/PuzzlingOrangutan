...
def main(project_name, release_name):
    """
    Main function parses returns from read_test_cases_and_requirements and read_results and posts request to results
    server
    :param project_name: String value name of the project
    :param release_name: String value name of the release
    :return: post function return value
    """
...
def read_results():
    """
    This function collects results from xml files generated by pytest run
    :return: dict of test results with result as a value
    """
    all_test_cases = {}
