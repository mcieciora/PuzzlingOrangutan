...
def test__check_index_endpoint_status():
    ...
    actual_data = get("http://localhost:8007/")
...
def test__create_user_when_username_provided_by_endpoint():
    ...
    :return: None
    """
    expected_data = {"status": 200, "message": f"User new_user created successfully."}
    actual_data = get("http://localhost:8007/create_user/new_user")
    assert actual_data.json()["data"] == expected_data, f"Endpoint return is different than expected. " \
                                                        f"Actual: {actual_data}, Expected: {expected_data}"
...
def test__get_list_of_all_users_with_subscriptions_by_endpoint():
    ...
    actual_data = get("http://localhost:8007/get_subscriptions")
...
def test__create_service_when_service_name_provided_by_endpoint():
    ...
    :return: None
    """
    expected_data = {"status": 200, "message": f"Service new_service created successfully"}
    actual_data = get("http://localhost:8007/create_service/new_service")
    assert actual_data.json()["data"] == expected_data, f"Endpoint return is different than expected. " \
                                                 f"Actual: {actual_data}, Expected: {expected_data}"
...
def test__subscribe_to_service_with_proper_values_by_endpoint():
    ...
    actual_data = get("http://localhost:8007/subscribe/new_user/new_service")
    assert actual_data.json()["data"] == expected_data, f"Endpoint return is different than expected. " \
                                                 f"Actual: {actual_data}, Expected: {expected_data}"
...
def test__subscribe_service_with_wrong_username_provided_by_endpoint():
    ...
    actual_data = get("http://localhost:8007/subscribe/not_existing/new_service")
    assert actual_data.json()["data"] == expected_data, f"Endpoint return is different than expected. " \
                                                 f"Actual: {actual_data}, Expected: {expected_data}"
...
def test__subscribe_service_with_wrong_service_name_provided_by_endpoint():
    ...
    actual_data = get("http://localhost:8007/subscribe/new_user/not_existing")
    assert actual_data.json()["data"] == expected_data, f"Endpoint return is different than expected. " \
                                                 f"Actual: {actual_data}, Expected: {expected_data}"
...
def test__get_list_of_all_services_by_endpoint():
    ...
    actual_data = get("http://localhost:8007/get_services")
    assert actual_data.json() == expected_data, f"Endpoint return is different than expected. " \
                                                 f"Actual: {actual_data}, Expected: {expected_data}"
