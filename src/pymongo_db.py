...
class MongoDb:
    ...
    def create_user(self, username):
        ...
        if query_search:
            raise src.exceptions.UsernameAlreadyExists
    ...
    def create_service(self, service_name):
        ...
        if query_search:
            raise src.exceptions.ServiceAlreadyExists
